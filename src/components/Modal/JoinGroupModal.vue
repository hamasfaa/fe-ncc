  ...
  <Teleport to="body">
    ...
    >
      <div class="bg-white rounded-lg shadow-xl w-full max-w-md mx-4">
        ...
        >
          <h3 class="text-xl font-semibold text-gray-800">Join Group</h3>
          <button
        ...
        <div class="p-6">
          <form class="space-y-4" @submit.prevent="handleJoinGroup">
            <div class="space-y-2">
...
export default {
  ...
  methods: {
    async handleJoinGroup() {
      try {
        await this.API_STORE.joinGroup(this.groupName);
        this.groupName = "";
      } finally {
        this.MODAL_STORE.toggleJoin();
      }
    },
  },
};
